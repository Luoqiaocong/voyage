...
from .schemas import ItineraryDetailResponse, ItineraryPatch, UpdateItineraryRequest, ItinerariesResponse
...
class ItineraryRouter:
    ...
    async def get_itineraries(self):
        ...
        return ItinerariesResponse(itineraries = [ItineraryDetailResponse.model_validate(i) for i in itineraries])
