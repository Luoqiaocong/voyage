 ...
 * 管理台入口：**两种管理员**都展示。
 *
 * 判断收敛到 utils/role.ts，避免入口条件与后端权限判断不一致。
 *
 ...
 *
 * 内边距 7px 14px 是让胶囊有形状；间距 6px：视觉间隔由内边距承担，
 * 整体占宽更紧凑，而每项的可点区域明显变大。
 */
...
/* 下拉指示：用描边图标而不是 CSS 三角形 —— 三角在圆角按钮里显得糙 */
.usermenu__caret {
  color: var(--text3);
